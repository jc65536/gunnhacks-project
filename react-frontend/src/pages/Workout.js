    ...
    render() {
        return (
            <div>
                ...
                <h1>Squat Reps: {this.state.squatReps}</h1>
                <h1>Jumping Jack Reps: {this.state.jumpingJackReps}</h1>
                <h1>squatKeyPos: {this.state.squatKeyPos}</h1>
                <h1>jumpingKeyPos: {this.state.jumpingKeyPos}</h1>
